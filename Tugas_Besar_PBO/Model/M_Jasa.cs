...
namespace Tugas_Besar_PBO.Model
{
    ...
    {
        string jenis_jasa, rank, jumlah_bintang, harga,total_harga, penjoki, metode_pembayaran, no_whatsapp, email, password, jenis_akun;
        public M_Jasa()
        {
        }
        public M_Jasa(string jenis_jasa,string rank, string jumlah_bintang ,string harga,string total_harga, string penjoki, string metode_pembayaran, string no_whatsapp, string email,string password, string jenis_akun)
        {
