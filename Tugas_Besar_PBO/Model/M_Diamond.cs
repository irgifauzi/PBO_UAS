...
namespace Tugas_Besar_PBO.Model
{
    ...
    {
        string id_username, id_server, jumlah_diamond,bonus_diamond,  harga, email, metode_pembayaran;
        public M_Diamond()
        {
        }
        public M_Diamond(string id_username, string id_server, string jumlah_diamond,string bonus_diamond,  string harga, string email, string metode_pembayaran)
        {
