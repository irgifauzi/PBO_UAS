    ...
    public partial class Form_Diamond : Form
    {
        ...
        private void bayar_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(tbid.Text) ||
                ...
                (!rbdana.Checked && !rbgopay.Checked && !rbovo.Checked && !rbbrimo.Checked))
            {
            ...
            else
            {
                ...
                m_Diamond.Metode_pembayaran = rbovo.Checked ? "OVO" :
                                   (rbgopay.Checked ? "GOPAY" :
                                   (rbdana.Checked ? "DANA" :
                                   (rbbrimo.Checked ? "BRIMO" : "")));

                // Perform the insert or further processing
